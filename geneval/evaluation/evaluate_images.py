...
def load_models(args):
    ...
    clip_model, _, transform = open_clip.create_model_and_transforms(
        clip_arch, 
        pretrained=os.path.join(args.model_path, 'models--timm--vit_large_patch14_clip_224.openai/snapshots/18d0535469bb561bf468d76c1d73aa35156c922b/open_clip_pytorch_model.bin'), 
        device=DEVICE)
